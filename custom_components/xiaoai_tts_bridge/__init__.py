...
class XiaoAiTtsRuntimeData:
    """Runtime data for a XiaoAI TTS Bridge config entry."""
...
async def async_setup_entry(
    ...
    """Set up XiaoAI TTS Bridge from a config entry."""
...
async def async_unload_entry(
    ...
    """Unload a XiaoAI TTS Bridge config entry."""
